...
const Footer = () => {
    return (
        <div className="max-w-screen-xl mx-auto  bg-[#ECF5FF] text-[#475467] font-semibold">
            <footer className="footer text-base-content p-9">
                <aside>
                    <img className="w-13 h-20" src="https://i.ibb.co/8PN85zP/e8cbbb0006f4af5b4764c7061ba11f37.png" alt="" />
            ...
            <div className="md:flex justify-between p-4 my-4 ">
                <div className="py-2">
                    © 2024 Heritage- Nest . All rights reserved.
                </div>
                <div className="flex gap-4 py-4 justify-center ">
                    <img src="https://i.ibb.co/Bz4JnNP/Twitter.png" alt="" />
                    <img src="https://i.ibb.co/n6QkzwV/Linkedin.png" alt="" />
                    <img src="https://i.ibb.co/W66kbSK/Facebook.png" alt="" />
                    <img src="https://i.ibb.co/N6zkjCJ/icon.png" alt="" />
