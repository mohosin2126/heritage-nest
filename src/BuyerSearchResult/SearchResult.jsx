...
const SearchResult = () => {
    ...
    const properties = [
        {
            image: "https://i.ibb.co/5Fq68Dj/searchresult.png",
    ...
    return (
        <div>
            ...
            <div className="flex gap-8">
                <span className="p-2 text-lg bg-blue-500 text-white rounded">properties (400)</span>
                <span className="p-2 text-lg bg-blue-50 ">New Projects (400)</span>
                <span className="p-2 text-lg bg-blue-50 ">Pre-launch offers</span>
            </div>
                                                ...
                                                <div className="md:flex gap-5 p-6"><img className="mx-auto" src={property.image} alt="" />
                                                    <div>
                                                        ...
                                                        <div className="flex justify-between items-center my-4 gap-3">
                                                            ...
                                                            <Link>
                                                            <button className="p-2 border-2 border-black rounded">Bid Property</button></Link>
                                                        </div>
